...
pub async fn page_heading(eyebrow: &str, title: &str, lede: &str) -> Result<impl View> {
    Ok(view! {
        ...
        if !lede.is_empty() {
            <p class=("mt-4 max-w-2xl text-lg leading-relaxed ".to_string() + SOFT)>
                (lede)
            </p>
        }
    })
...
pub async fn product_tile(p: Product) -> Result<impl View> {
    ...
    Ok(view! {
        ...
        >
            <div
                class="relative aspect-square overflow-hidden rounded-2xl bg-oat-100 ring-1 ring-oat-200 transition duration-300 group-hover:shadow-xl group-hover:shadow-oat-900/10 group-hover:ring-gin-300"
                data-vt=(&p.sku)
            ...
            >
                ...
                if is_new {
                    <span
                        class="absolute left-3 top-3 rounded-full bg-gin-700 px-2.5 py-1 text-xs font-medium uppercase tracking-widest text-oat-50"
                    >
                        "Nouveau"
                    </span>
                }
                if sold_out {
                    <span
                        class="absolute inset-x-0 bottom-0 bg-oat-900/85 py-2 text-center text-xs font-medium text-oat-50"
                    >
                        "Épuisé"
                    </span>
                }
...
async fn suggestions(cx: &Cx, term: String) -> Result<impl View> {
    ...
    Ok(view! {
        if !term.is_empty() {
            <div
                class="animate-apparition rounded-2xl bg-white p-2 shadow-lg ring-1 ring-oat-200"
            >
                if nothing {
                    <p class=("px-3 py-2 text-sm ".to_string() + MUTED)>
                        "Rien pour « "
                        (&term)
                        " »"
                    </p>
                    ...
                    <a
                        href=(href!("/recherche").query(Term { q: &term }))
                        class=("mt-1 block rounded-xl px-3 py-2 text-sm underline underline-offset-4 ".to_string(

                            )
                            + MUTED)
                    >
                        (format!(
                            "Voir {how_many} résultat{}",
    ...
    Ok(view! {
        ...
        <html lang="fr">
            <head>
                ...
                <meta
                    name="description"
                    content="Le vestiaire et la papeterie de Bernard : coton biologique, papeterie soignée, et un crabe qui s'y connaît en petites coquilles."
                >
                <link
                    rel="icon"
                ...
                <link
                    ...
                    title="Le journal de Bernard"
                    href="/journal/flux.xml"
                >
                <link rel="sitemap" href="/sitemap.xml">
                <meta
                    property="og:description"
                    content="Le vestiaire et la papeterie de Bernard : coton biologique, papeterie soignée, séries courtes."
                >
                head_assets()
            </head>
            <body class="min-h-screen">
                <a
                    href="#contenu"
                    class="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-full focus:bg-gin-800 focus:px-5 focus:py-2.5 focus:text-sm focus:text-oat-50"
                >
                    "Aller au contenu"
                </a>
                <p
                    class="bg-gin-800 px-6 py-2.5 text-center text-xs tracking-wide text-gin-100"
                >
                ...
                <header
                    class="sticky top-0 z-40 border-b border-oat-200 bg-oat-50/90 backdrop-blur-sm"
                >
                    <div class="mx-auto flex h-16 max-w-6xl items-center gap-6 px-6">
                        ...
                        <details class="relative md:hidden">
                            <summary
                                aria-label="Menu"
                                class="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full ring-1 ring-oat-300 transition hover:bg-oat-100"
                            >
                            ...
                            <div
                                class="absolute left-0 top-full z-50 mt-3 w-72 rounded-2xl bg-white p-3 shadow-lg ring-1 ring-oat-200"
                            >
                                <form
                                    action="/recherche"
                                    method="get"
                                    class="relative px-2 pt-1"
                                >
                                    <input
                                        name="q"
                                        type="search"
                        ...
                        <form
                            action="/recherche"
                            method="get"
                            class="relative ml-auto hidden lg:block"
                        ...
                        >
                            ...
                            <button
                                aria-label="Chercher"
                                class="absolute inset-y-0 right-1 my-auto flex h-8 w-8 items-center justify-center rounded-full text-oat-600 transition hover:bg-oat-100 hover:text-gin-700"
                            >
                                "→"
                            </button>
                            ...
                            <div
                                class="absolute right-0 top-full z-50 mt-2 w-80"
                                :hidden=$(open.get() == 0.0)
                        ...
                        <div class="ml-auto flex items-center gap-4 lg:ml-0">
                            <a
                                href="/compte"
                                class="text-sm transition hover:text-gin-700"
                            >
                                (if signed_in { "Mon compte" } else { "Connexion" })
                            </a>
                            <a
                                href="/panier"
                                class="inline-flex items-center gap-2 rounded-full bg-oat-900 px-4 py-2 text-sm text-oat-50 transition hover:bg-gin-800"
                            >
                                "Panier"
                                if items > 0 {
                                    <span
                                        class="inline-flex h-5 items-center justify-center rounded-full bg-oat-50 px-1.5 text-xs font-medium tabular-nums text-oat-900"
                                    >
                                        (items)
                                    </span>
                                }
                            ...
                            Ok(
                                view! {
                                    ...
                                    <section class="mx-auto max-w-xl py-24 text-center">
                                        ...
                                        <p
                                            class=("mt-5 text-lg leading-relaxed ".to_string() + SOFT)
                                        >
                    ...
                    <div class="mx-auto max-w-6xl px-6 py-14">
                        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                            <div>
                                ...
                                <p
                                    class=("mt-3 text-sm leading-relaxed ".to_string() + MUTED)
                                >
                            ...
                            <div>
                                ...
                                <ul
                                    class=("mt-4 space-y-2.5 text-sm ".to_string() + MUTED)
                                >
                                    <li>
                                        <a href="/boutique" class="transition hover:text-gin-700">
                                            "Tous les articles"
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="/boutique?categorie=Vêtements"
                                    ...
                                    <li>
                                        <a href="/recherche" class="transition hover:text-gin-700">
                                            "Recherche"
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div>
                                ...
                                >
                                    <li>
                                        <a href="/aide" class="transition hover:text-gin-700">
                                    ...
                                    <li>
                                        <a href="/contact" class="transition hover:text-gin-700">
                                            "Nous écrire"
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/compte" class="transition hover:text-gin-700">
                                            "Suivre ma commande"
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div>
                                ...
                                >
                                    <li>
                                        <a href="/maison" class="transition hover:text-gin-700">
                                            "Notre histoire"
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/journal" class="transition hover:text-gin-700">
                                            "Journal"
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/cgv" class="transition hover:text-gin-700">
                                            "Conditions de vente"
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    if is_admin {
                                        <li>
                                            <a
                                                href="/admin"
                                                class="text-gin-700 transition hover:text-gin-800"
                                            >
                                                "Administration"
                                            </a>
                                        </li>
                        ...
                        <p
                            class=("mt-12 border-t border-oat-200 pt-6 text-xs ".to_string(
    ...
    Ok(view! {
        ...
        <section class="mt-24">
            ...
            <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                for c in categories {
                    <a
                        href=("/boutique?categorie=".to_string() + &c)
                    ...
                    >
                        ...
                        <span class="text-gin-700 transition group-hover:translate-x-1">
                            "→"
                        </span>
                    </a>
                }
        ...
        <section
            class="mt-24 rounded-3xl bg-oat-100 px-6 py-12 ring-1 ring-oat-200 sm:px-10"
        >
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                for (icon, title, text) in PROMISES {
                    <div>
                        ...
                        <p class=("mt-1 text-sm leading-relaxed ".to_string() + MUTED)>
                            (text)
                        </p>
                    </div>
                }
        ...
        <section
            id="lettre"
            class="relative mt-24 overflow-hidden rounded-3xl bg-gin-900 px-6 py-14 text-center sm:px-10"
        >
            // The tide itself, blurred behind the same green veil as the
            // order banner: one letter per tide, and here is the tide.
            <img
                src=(crate::images::url("lettre-maree", 900))
                alt=""
                aria-hidden="true"
                loading="lazy"
            ...
            <div class="relative">
                <p class="text-xs font-medium uppercase tracking-[0.2em] text-gin-200">
                    "La lettre de la coquille"
                </p>
                <h2 class="mt-3 text-3xl text-oat-50 sm:text-4xl">
                    "Une lettre par marée, pas plus"
                </h2>
                ...
                if thanks {
                    <p
                        class="animate-apparition mx-auto mt-8 inline-flex items-center gap-2 rounded-full bg-oat-50 px-5 py-2.5 text-sm font-medium text-gin-800"
                    >
                    ...
                    <form
                        method="post"
                        action="/newsletter"
                        class="mx-auto mt-8 flex max-w-md gap-3"
                    >
                        <input
                            name="email"
                            type="email"
                        ...
                        >
                        <button
                            class="shrink-0 rounded-full bg-oat-50 px-5 py-2.5 text-sm font-medium text-gin-900 transition hover:bg-oat-100"
                        >
                            "S'abonner"
                        </button>
                    </form>
                    if invalid {
                        <p class="mt-4 text-sm text-brique-100">
        ...
        <section class="mt-24 grid items-center gap-10 lg:grid-cols-2">
            ...
            >
                <img
                    src=(crate::images::url("journal-coton", 900))
                    srcset=(format!(
                        "{} 900w, {} 1600w",
                        crate::images::url("journal-coton", 900),
                        crate::images::url("journal-coton", 1600),
                    ))
            ...
            <div>
                ...
                <a href="/journal" class=(BTN_OUTLINE.to_string() + " mt-8")>
                    "Lire le journal"
                </a>
            </div>
        </section>
